    ...
    if arguments == False:
        ...
        async with message.channel.typing():
            ...
            if len(radio_player.queue) > 0:
                song = await get_song(message, message.author.id, False, query, False, False, radio_player.queue[len(radio_player.queue) - 1].title)
            else:
